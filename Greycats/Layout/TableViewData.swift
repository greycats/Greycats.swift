...
open class TableViewSource<T: Equatable>: SectionData {
    ...
    fileprivate var deselectAfterward = true
...
open class TableViewDataNib<T: Equatable, U: UITableViewCell>: TableViewData<T, U> where U: TableViewDataNibCell {
    ...
    override open func didSetTableView(_ tableView: UITableView) {
...
open class TableViewDataCombine<T: Equatable, U: UITableViewCell>: TableViewData<T, U> where U: TableViewDataCustomizeRegister {
    ...
    override open func willSetTableView(_ tableView: UITableView) {
...
open class TableViewData<T: Equatable, U: UITableViewCell>: TableViewSource<T> {
    ...
    fileprivate var renderCell: ((U, T, () -> Void) -> Void)?
    ...
    @discardableResult
    open func onFutureRender(_ render: @escaping (U, T, () -> Void) -> Void) -> Self {
        renderCell = render
        return self
    }
    ...
    override fileprivate func _applyChange(_ change: Change<T>) {
        super._applyChange(change)
        didChange?()
    }

    override open func tableView(_ tableView: UITableView, heightForRowAtIndexPath indexPath: IndexPath) -> CGFloat {
        return UITableView.automaticDimension
    }

    override open func tableView(_ tableView: UITableView, cellForRowAtIndexPath indexPath: IndexPath) -> UITableViewCell {
    ...
    override open func tableView(_ tableView: UITableView, willDisplayCell cell: UITableViewCell, forRowAtIndexPath indexPath: IndexPath) {
